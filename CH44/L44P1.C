...
extern void __cdecl DrawRect(int,int,int,int,int,unsigned int,unsigned int);
extern void __cdecl ShowPage(unsigned int);
extern void __cdecl DrawImage(int,int,image **,int,unsigned int,unsigned int);
extern void __cdecl ShowBounceCount(void);
extern void __cdecl TextUp(char *,int,int,unsigned int,unsigned int);
extern void __cdecl SetBIOS8x8Font(void);
